...
Here is the post: " + tweet,
        ...
        infer_data = []
        # if idx==3: break   # used for testing
...
def infer_all():
    ...
    with open('./dataset/climate_infer_results_gpt.csv', 'w', newline='') as f:
    # with open('./dataset/cyber_infer_results_gpt.csv', 'w', newline='') as f:
    # with open('./dataset/climate_infer_results_gpt.csv', 'w', newline='') as f:
